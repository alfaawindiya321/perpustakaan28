...
<table class="table table-striped table-hover">
    ...
    ?>
      <?php
      //Query Join 3 tabel//////////////////////////////////////////////////////////////////////
    $querybaru = mysqli_query($konek,"SELECT * FROM anggota.nis, anggota.nama, anggota.jk, anggota.tempat_lahir, anggota.tanggal_lahir, anggota.id_kelas, anggota.id_jurusan, anggota.nomor_telepon, anggota.alamat, kelas.nama_kelas, kelas.nama_jurusan,
    FROM anggota
